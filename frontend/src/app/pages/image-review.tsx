...
export default function ImageReview() {
  ...
  const { segments, updateSegment, runId, globalEmotion } = useProject();
      ...
      const promises = segments.map(async (seg, index) => {
        ...
        try {
          ...
          if (e.name === 'AbortError') {
            console.error(`Timeout: segment ${index} took too long`);
          } else {
  ...
  const handleRegenerateSubmit = async () => {
    ...
    updateSegment(index, { generated_image_url: undefined, runware_url: undefined });
